...
export declare type WarixStateActionReducer = (state: Map<string, any>, action: IWarixStateAction) => IWarixStateAction | IWarixStateReducerResult<IWarixStateAction>;
export declare type WarixStateDataReducer = (state: Map<string, any>, action: IWarixStateAction) => Map<string, any> | IWarixStateReducerResult<Map<string, any>>;
